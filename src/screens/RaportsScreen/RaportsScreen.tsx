...
const RaportsScreen = () => {
  ...
  const List = ({visits}) => {
    return (
      <>
        {visits.map((blood) => {
          return <SingleVisit key={blood.date} {...blood} />;
        })}
      </>
    );
  };
  ...
  return (
    <Screen>
      <Main>
        <Logo source={require('../../../assets/images/BloodBank.png')} />
        <Header>Twoje wizyty w Centrum Krwiodawstwa w Krakowie:</Header>
      </Main>
      <Container>
        <Data>
          <DataText>Data</DataText>
          <DataText>Cel wizyty</DataText>
        </Data>
        <List visits={visits} />
      </Container>
    </Screen>
